...
export const Detail: React.FC = () => {
  ...
  return (
    <div className="space-y-10 sm:space-y-12 overflow-x-hidden">
      <nav className="flex flex-wrap items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12">
          <div className="flex-1 space-y-8 sm:space-y-10 min-w-0">
            <header>
              ...
              <h1 className="font-headline text-3xl sm:text-4xl lg:text-5xl font-extrabold text-primary leading-tight mb-4 tracking-tight">
                {displayData.title.split(' ').slice(0, -1).join(' ')} <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                  {displayData.title.split(' ').slice(-1)[0]}
                </span>
              </h1>
              <p className="text-slate-500 flex flex-wrap items-center gap-3 text-base sm:text-lg lg:text-xl font-light">
            ...
            <div className="relative group bg-slate-50 rounded-[2rem] md:rounded-[3rem] overflow-hidden aspect-[4/5] sm:aspect-[3/4] max-h-[540px] md:max-h-[800px] shadow-inner border-4 border-white ring-1 ring-slate-100">
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 sm:p-8 md:p-16 text-center">
          ...
          <div className="w-full lg:w-[400px] space-y-8 sm:space-y-10 min-w-0">
            <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-[2rem] sm:rounded-[3rem] shadow-sm border border-slate-100 relative overflow-hidden">
            ...
            <div className="bg-slate-50/50 p-6 sm:p-8 lg:p-10 rounded-[2rem] sm:rounded-[3rem] border border-slate-100 space-y-8">
      ...
      <button 
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-10 md:right-10 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-secondary text-white rounded-2xl shadow-[0_20px_50px_rgba(220,38,38,0.3)] flex items-center justify-center hover:scale-110 transition-transform z-50 group active:scale-95"
      >
