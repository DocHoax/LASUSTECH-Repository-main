        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-blue-100">
              ...
              <li><button className="hover:text-white transition-colors">Contact Admin</button></li>
            </ul>
          </div>
        </div>
...
const FooterLinks: React.FC = () => {
  ...
  return (
    <ul className="space-y-4 text-sm text-blue-100">
      ...
      <li><button className="hover:text-white transition-colors">Academic Calendar</button></li>
    </ul>
  );
};
